 ...
 * Preserves 100% of the cinematic visuals, specular reflections, and glassmorphic depth
 * with optimized single-pass rendering and zero CSS transition/rAF thrashing.
 */
export const HeroMediaCard = React.forwardRef<HTMLElement, HeroMediaCardProps>(function HeroMediaCard(
  ...
  return (
    ...
    >
      ...
      {/* FRONT FACE: True 3D Glass Masterpiece */}
      <div
      ...
      >
        {article.id.startsWith("skeleton-") ? (
          ...
          <>
            ...
            {/* Layer 5: Exact 45% Height Description Overlay Footer (Glassmorphic Material) */}
      ...
      {/* BACK FACE: Sleek Cybernetic Matte Glass Backplate */}
      <div
        className="absolute inset-0 w-full h-full flex flex-col items-center justify-center bg-neutral-950/95 rounded-2xl overflow-hidden border border-white/15 shadow-[inset_0_1px_1px_rgba(255,255,255,0.2),0_15px_30px_rgba(0,0,0,0.85)] p-6 select-none"
        style={{
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center gap-3 z-10 opacity-40 group-hover:opacity-75 transition-opacity duration-300">
          <div className="w-10 h-10 rounded-xl bg-white/[0.05] border border-white/15 flex items-center justify-center shadow-inner">
            <Sparkles className="w-5 h-5 text-primary" />
          </div>
          <span className="text-[10px] font-mono font-bold uppercase tracking-[0.25em] text-white/60">
            TECH NEWS TODAY
          </span>
