...
SLUG_ALIASES = {
    ...
    "apple": ["7", "apple-newsroom", "apple newsroom", "apple"],
    "apple-newsroom": ["7", "apple-newsroom", "apple newsroom", "apple"],
    "microsoft": ["microsoft-blog", "microsoft blog", "microsoft"],
    "microsoft-blog": ["microsoft-blog", "microsoft blog", "microsoft"],
    "meta": ["meta-newsroom", "meta newsroom", "meta"],
    "meta-newsroom": ["meta-newsroom", "meta newsroom", "meta"],
