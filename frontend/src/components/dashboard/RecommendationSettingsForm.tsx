...
export function RecommendationSettingsForm({ compact = false }: { compact?: boolean }) {
  ...
  const handleToggle = (key: keyof RecommendationSettings, explicitVal: boolean) => {
    updateSettings({ [key]: explicitVal });
  };
    ...
    return (
      <div className="bg-card/50 border border-border/50 p-6 rounded-2xl">
        ...
        <div className="space-y-4">
          <label
            htmlFor="hideReadArticles-compact"
          ...
          >
            ...
            <input 
              ...
              onChange={(e) => handleToggle("hideReadArticles", e.target.checked)}
              className="w-4 h-4 accent-primary cursor-pointer"
            />
          </label>
          <label
            htmlFor="preferTrustedSources-compact"
            className="flex items-center justify-between cursor-pointer group select-none"
          >
            ...
            <input 
              ...
              onChange={(e) => handleToggle("preferTrustedSources", e.target.checked)}
              className="w-4 h-4 accent-primary cursor-pointer"
            />
          </label>
          <label
            htmlFor="showBreakingNews-compact"
            className="flex items-center justify-between cursor-pointer group select-none"
          >
            ...
            <input 
              ...
              onChange={(e) => handleToggle("showBreakingNews", e.target.checked)}
              className="w-4 h-4 accent-primary cursor-pointer"
            />
          </label>
        </div>
  ...
  return (
    <div className="space-y-8 max-w-2xl">
      <section className="bg-card border border-border/50 p-6 rounded-2xl">
        ...
        <div className="space-y-4">
          <label
            htmlFor="priority-relevance"
            className={`flex items-center gap-3 cursor-pointer p-3 rounded-lg transition-colors border select-none ${
              recommendationSettings.prioritize === "relevance"
                ? "bg-primary/5 border-primary/30"
                : "hover:bg-background/50 border-transparent hover:border-border"
            }`}
          >
            <input 
          ...
          <label
            ...
            className={`flex items-center gap-3 cursor-pointer p-3 rounded-lg transition-colors border select-none ${
              recommendationSettings.prioritize === "balanced"
                ? "bg-primary/5 border-primary/30"
                : "hover:bg-background/50 border-transparent hover:border-border"
            }`}
          >
          ...
          <label
            htmlFor="priority-freshness"
            className={`flex items-center gap-3 cursor-pointer p-3 rounded-lg transition-colors border select-none ${
              recommendationSettings.prioritize === "freshness"
                ? "bg-primary/5 border-primary/30"
                : "hover:bg-background/50 border-transparent hover:border-border"
            }`}
          >
      ...
      <section className="bg-card border border-border/50 p-6 rounded-2xl">
        ...
        <div className="space-y-4">
          <label 
            htmlFor="hideReadArticles"
            className={`flex items-center justify-between cursor-pointer p-3 rounded-lg transition-colors border select-none ${
              recommendationSettings.hideReadArticles 
                ? "bg-primary/5 border-primary/30" 
                : "hover:bg-background/50 border-transparent hover:border-border"
            }`}
          >
          ...
          <label 
            htmlFor="preferTrustedSources"
            className={`flex items-center justify-between cursor-pointer p-3 rounded-lg transition-colors border select-none ${
              recommendationSettings.preferTrustedSources 
                ? "bg-primary/5 border-primary/30" 
                : "hover:bg-background/50 border-transparent hover:border-border"
            }`}
          >
          ...
          <label 
            htmlFor="showBreakingNews"
            className={`flex items-center justify-between cursor-pointer p-3 rounded-lg transition-colors border select-none ${
              recommendationSettings.showBreakingNews 
                ? "bg-primary/5 border-primary/30" 
                : "hover:bg-background/50 border-transparent hover:border-border"
            }`}
          >
          ...
          <label 
            htmlFor="includeEmergingTopics"
            className={`flex items-center justify-between cursor-pointer p-3 rounded-lg transition-colors border select-none ${
              recommendationSettings.includeEmergingTopics 
                ? "bg-primary/5 border-primary/30" 
                : "hover:bg-background/50 border-transparent hover:border-border"
            }`}
          >
            ...
            <input 
              ...
              onChange={(e) => handleToggle("includeEmergingTopics", e.target.checked)}
              className="w-5 h-5 accent-primary cursor-pointer"
            />
          </label>
        </div>
