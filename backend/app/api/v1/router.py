...
api_router.include_router(sources.sources_router, prefix="/sources", tags=["Sources"])
api_router.include_router(sources.following_router, prefix="/following", tags=["Following"])
api_router.include_router(sources.user_following_router, prefix="/users/me/following", tags=["Sources"])
...
api_router.include_router(personalization.router, prefix="/users/me", tags=["Personalization"])
