          ...
          <div className="space-y-3 p-4 rounded-xl border border-white/15 bg-white/[0.03]">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                disabled={isSaving}
                className={`px-3 py-1 rounded-full font-mono text-[11px] font-semibold tracking-wider transition-all cursor-pointer ${
                  enabled
            ...
            <div className="space-y-2 pt-1">
              ...
              <button
                ...
                className="w-full py-2 bg-muted/60 hover:bg-muted text-foreground border border-white/10 rounded-lg text-xs font-mono font-medium flex items-center justify-center gap-1.5 transition-colors disabled:opacity-50 cursor-pointer"
              >
