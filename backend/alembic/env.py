...
from alembic import context  # Core config and model imports to register metadata
from app.core.config import settings
from app.models.base import Base

# Import all models to ensure Alembic detects them
import app.models.ai_artifacts
...
import app.models.tnt_knowledge
import app.models.story
import app.editorial.models
