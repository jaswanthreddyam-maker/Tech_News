...
export const FALLBACK_SOURCES: SourceItem[] = [
  ...
  { slug: "google-deepmind", name: "Google DeepMind", category: "official", description: "Cutting-edge artificial intelligence, AlphaFold, and fundamental science from DeepMind.", logo_url: null, url: "https://deepmind.google/blog/feed/basic/", credibility_score: 0.98, is_following: false },
